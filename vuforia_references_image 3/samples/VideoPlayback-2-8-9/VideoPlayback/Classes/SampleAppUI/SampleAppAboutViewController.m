...
- (void)viewDidLoad
{
    ...
    //navigationbar生成
    UIBarButtonItem *startButton = [[UIBarButtonItem alloc] initWithTitle:@"camera" style:UIBarButtonItemStylePlain target:self action:@selector(startButtonTapped:)];
...
- (void)startButtonTapped:(id)sender {
    //Class:は構造体？
    //「appViewControllerClassName = videoplaybackviewcontroller」なので下記コードはvideoplaybackviewcontrollerへ遷移
